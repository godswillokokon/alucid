    ...
    <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card">
                        <div class="body text-center">
                            <div class="chart easy-pie-chart-1" data-percent="37"> <span><img src="http://www.wrraptheme.com/templates/lucid/hospital/assets/images/sm/avatar2.jpg" data-toggle="tooltip" data-placement="top" title="Dr. Avatar" alt="user" class="rounded-circle"/></span> </div>
                            <h6 class="mb-0"><a href="#" title="">${Hname}</a></h6>
                            <small>${Hrole}</small>
